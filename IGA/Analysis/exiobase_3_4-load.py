...
os.getcwd()
mrio_dir = Path(r"C:\Users\patta\OneDrive\Desktop\EIOA\IGA\Analysis")                                                  

# Exiobase folder
exio_dir = Path(r"C:\Users\patta\OneDrive\Desktop\EIOA\IGA\Analysis\IOT_2011_pxp")
 
# Population file folder
pop_dir = Path(r"C:\Users\patta\OneDrive\Desktop\EIOA\IGA\Analysis\Population")
...
mrio = {'F': F, 'H': H, 'V': F_va, 'Y': Y, 'L': L, 'F_co2': F_co2, 'H_co2': H_co2, 'label': label, 'A': A, 'A_Covid' : A_Covid, 'Y_Covid' : Y_Covid, 'A_NOW1' : A_NOW1, 'Y_covid' : Y_NOW1 }
